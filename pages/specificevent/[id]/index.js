...
const SpecificEvent = () => {
  ...
  const openNotification = () => {
    notification.open({
      description: "Log in, to buy tickets",
    });
  };
              ...
              <Row justify="center" align="middle">
                {eventOne.early_timer > 0 ? (
                  <div style={{ textAlign: "left", fontFamily: "nunito" }}>
                    ...
                    <p style={{ fontSize: 20 }}>
                      <b>Regular Tickets Price ($):</b>{" "}
                      {eventOne.early_booking_price_regular}
                    </p>
                    <p style={{ fontSize: 20 }}>
                      <b>Vip Tickets Price ($):</b>{" "}
                      {eventOne.early_booking_price_vip}
                    </p>
                  </div>
                ) : (
                  <div style={{ textAlign: "center", fontFamily: "nunito" }}>
                    ...
                    <p style={{ fontSize: 20 }}>
                      Regular Tickets ($): {eventOne.regular_price}
                    </p>
                    <p style={{ fontSize: 20 }}>
                      Vip Tickets ($): {eventOne.vip_price}
                    </p>
                  </div>
                )}
              </Row>
              ...
              <Row justify="center" align="middle">
                <Col span={6}>
                  <Row justify="start" align="middle">
                    <div style={{ textAlign: "center", fontFamily: "nunito" }}>
                      <h4 style={{ fontWeight: "bold", fontSize: 25 }}>Date</h4>
                      <p style={{ fontSize: 20 }}>
